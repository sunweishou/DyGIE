...
fn = '../../data/ace05_Chinese/json/test.json'
outfn = '../../data/ace05_Chinese/elmo/test.hdf5'
Elmo(fn, outfn)
fn = '../../data/ace05_Chinese/json/dev.json'
outfn = '../../data/ace05_Chinese/elmo/dev.hdf5'
Elmo(fn, outfn)
fn = '../../data/ace05_Chinese/json/train.json'
outfn = '../../data/ace05_Chinese/elmo/train.hdf5'
Elmo(fn, outfn)
